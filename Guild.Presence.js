          ...
          if(i.customId == "isimyapilandirma") {
              ...
              .forEach(async (uye) => {
                ...
                if(data && data.Name && data.Gender == "Kayıtsız") {
                  if(uye && uye.manageable && ayarlar.type && ayarlar.isimyas) await uye.setNickname(`${ayarlar.tagsiz} ${data.Name}`).catch(err => {})
                  if(uye && uye.manageable && !ayarlar.type && ayarlar.isimyas) await uye.setNickname(`${data.Name}`).catch(err => {})
                  if(uye && uye.manageable && ayarlar.type && !ayarlar.isimyas) await uye.setNickname(`${ayarlar.tagsiz} ${data.Name}`).catch(err => {})
                } else {
                  if(uye && uye.manageable && ayarlar.type && ayarlar.isimyas) await uye.setNickname(`${ayarlar.tagsiz} İsim | Yaş`).catch(err => {})
                  ...
                  if(uye && uye.manageable && ayarlar.type && !ayarlar.isimyas) await uye.setNickname(`${ayarlar.tagsiz} Kayıtsız`).catch(err => {})
                }
