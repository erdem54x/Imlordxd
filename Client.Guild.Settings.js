                  ...
                  if(i.values[0] === "ayarlar1") {
                    ...
                    x.delete().catch(err => {})
                     await i.reply({files: [{
                      ...
                      name: `AC-${secretOluştur(5)}.passenger`,
